...
class PersistentKnowledgeDB {
  ...
  stats() {
    const counts = {};
    for (const table of ['knowledge_objectives','objective_topics','knowledge_entries','knowledge_sources','research_runs','research_evidence','browser_captures','browser_commands']) {
