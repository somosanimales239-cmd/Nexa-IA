...
Update **Nexa AI from 1.0.0 to 1.2.3** as one complete update. Preserve every working 1.0 feature and add a durable Knowledge Library system that lives outside model weights.
