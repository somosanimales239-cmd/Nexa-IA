# NEXA AI 1.3.0 — ONE-SHOT APP BUILDER PROMPT
...
Nexa AI 1.3.0 must keep its local Ollama architecture while adding a real model-independent persistent SQLite knowledge database and optional source-traced Internet research.
