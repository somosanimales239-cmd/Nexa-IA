# NEXA AI 1.2.6 — ONE-SHOT UPDATE PROMPT

Update the real Windows Electron application **Nexa AI** in repository:

`somosanimales239-cmd/Nexa-IA`

This is one complete update from 1.0.0 to **1.2.6**. Do not split it into a chain of partial versions. Preserve every working 1.0 capability and implement the full contract:
